...
public class CalcServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            String num3=request.getParameter("textnum3");
            String btnCalcular=request.getParameter("btnCalcular");  
            if (btnCalcular!=null) {  
                int resultado = Integer.parseInt(num1)/ Integer.parseInt(num2)*Integer.parseInt(num3);
